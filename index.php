...
while ($index < $num): ?><!--заполните этот список из массива категорий-->
        ...
        <ul class="lots__list">
            ...
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?= $item['img_url'] ?> "width="350" height="260" alt="<?= $item['title'] ?>">
                </div>
                <div class="lot__info">
                    <span class="lot__category"><?= $item['categori'] ?></span>
